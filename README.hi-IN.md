...
<p align="center">
  <img src="diagrams/diagram1_before_vs_after.png" alt="टोकन समस्या: flask का पूरा कॉर्पस पढ़ने में 143,594 टोकन लगते हैं, ग्राफ का उत्तर 2,712 टोकन में — 52.9 गुना कम। पूरा-कॉर्पस बेसलाइन एक ऊपरी सीमा है, कोई वास्तविक agent इतना नहीं पढ़ता" width="85%" />
</p>
...
बिल्ड समय रिपॉज़िटरी के आकार के साथ बढ़ता है; लगभग 3,000 फ़ाइलों की रिपॉज़िटरी का cold build लगभग 40 सेकंड लगा ([मापा गया](docs/REPRODUCING.md#incremental-update-latency))। उसके बाद, watch mode और समर्थित platform hooks से ग्राफ स्वचालित रूप से अपडेट हो सकता है।
...
हुक्स या watch mode सक्षम होने पर फ़ाइल सेव और समर्थित commit hooks incremental updates शुरू करते हैं। ग्राफ बदली हुई फ़ाइलों का डिफ़ लेता है, अपने ही import और call एजेज़ के ज़रिए उनके डिपेंडेंट्स ढूंढता है, और केवल उन्हीं फ़ाइलों को री-पार्स करता है जिनका SHA-256 हैश वास्तव में बदला है। लगभग 3,000 फ़ाइलों के प्रोजेक्ट (django) में दो फ़ाइलों का बदलाव hook path पर लगभग 2.5 सेकंड में री-इंडेक्स होता है, जिसमें ~1.4 सेकंड प्रोसेस स्टार्ट-अप है।
...
रिपॉज़िटरी जितनी बड़ी, टोकन की बर्बादी उतनी ही ज़्यादा चुभती है। पूरा कॉर्पस मॉडल को देने के बजाय ग्राफ उसका केवल उत्तर-भर हिस्सा लौटाता है: इस रिपॉज़िटरी में 208,821 सोर्स टोकन प्रति प्रश्न लगभग 2,547 टोकन बन जाते हैं — 82 गुना कम। यह तुलना एक **ऊपरी सीमा** है: यह मानती है कि ग्राफ के बिना agent हर सोर्स फ़ाइल पढ़ेगा। वास्तविक agent grep करके सबसे मेल खाती फ़ाइलें ही पढ़ता है, और उस बेसलाइन के मुकाबले मापी गई बचत लगभग **6 गुना** है।

<p align="center">
  <img src="diagrams/diagram6_monorepo_funnel.png" alt="code-review-graph रिपॉज़िटरी: 208,821 सोर्स टोकन सिमटकर लगभग 2,547 टोकन के ग्राफ उत्तर बनते हैं — पूरा-कॉर्पस ऊपरी सीमा के मुकाबले प्रति प्रश्न 82 गुना कम टोकन" width="80%" />
</p>
...
<p align="center">
  <img src="diagrams/diagram5_benchmark_board.png" alt="6 वास्तविक रिपॉज़िटरीज़ पर बेंचमार्क: grep-and-read agent के मुकाबले प्रति प्रश्न टोकन कमी का माध्य लगभग 6 गुना, ग्राफ-आधारित ग्राउंड ट्रुथ पर औसत F1 0.69" width="85%" />
</p>

**मुख्य आंकड़ा: एक grep-and-read agent के मुकाबले प्रति प्रश्न टोकन में लगभग 6 गुना कमी** (6 रिपॉज़िटरीज़ पर 18 प्रश्न; रेंज 3.5 गुना से 60 गुना)।

इसके बजाय रिपॉज़िटरी की **हर** फ़ाइल पढ़ने पर अनुपात लगभग **50 गुना** है (माध्य; रेंज 31 गुना से 326 गुना)। वह एक ऊपरी सीमा है जो कोई वास्तविक agent नहीं चुकाता, इसलिए उसे केवल ऊपरी सीमा के रूप में उद्धृत किया जाता है।

सभी आंकड़े 6 वास्तविक ओपन-सोर्स रिपॉज़िटरीज़ (13 कमिट्स, 18 agent प्रश्न, 11 मल्टी-हॉप टास्क) पर स्वचालित मूल्यांकन रनर से आते हैं, और **2026-09-16 को वर्तमान `staging` पर दोबारा मापे गए**। `code-review-graph eval --embed` से पुनः प्राप्त करें। विस्तृत बेंचमार्क डेटा के लिए [अंग्रेज़ी README](README.md) देखें।
...
| विशेषता | विवरण |
|---------|--------|
| **इंक्रीमेंटल अपडेट** | केवल उन्हीं फ़ाइलों को री-पार्स करता है जिनका हैश बदला है। ~3,000 फ़ाइलों की रिपॉज़िटरी में दो फ़ाइलों का बदलाव hook path पर ~2.5 सेकंड। |
